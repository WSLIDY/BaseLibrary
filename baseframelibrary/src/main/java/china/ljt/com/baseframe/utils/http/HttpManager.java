package china.ljt.com.baseframe.utils.http;
...
import china.ljt.com.baseframe.utils.ImageUtils;
import okhttp3.Call;
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    File file1 = new File(destFileDir);//仅创建路径的File对象
                    if (!file1.exists()) {
                        file1.mkdir();//如果路径不存在就先创建路径
                    }
                    File file = new File(file1, getFileName(url));
