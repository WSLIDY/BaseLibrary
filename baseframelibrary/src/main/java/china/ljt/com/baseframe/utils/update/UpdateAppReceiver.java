 ...
 public class UpdateAppReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (UpdateAppUtils.showNotification){
            ...
            if (UpdateAppUtils.image != 0) {
                builder.setSmallIcon(UpdateAppUtils.image);
            } else {
                builder.setSmallIcon(R.mipmap.ic_launcher);
            }
            builder.setProgress(100,progress,false);
            if (iDownLoadProcess != null) {
                iDownLoadProcess.proces(progress);
            }
    ...
    public static IDownLoadProcess iDownLoadProcess;
    public interface IDownLoadProcess {
        void proces(int process);
    }
}
